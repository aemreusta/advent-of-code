    ...
    while len(digits) < 10:
        for id, word in enumerate(line):
            ...
            if word_length == 5: # 2, 3, 5 
                if "7" in digits and all([i in list(word) for i in list(digits.get("7"))]):
                    digits["3"] = word
                    
                elif "9" in digits and all([i in list(digits.get("9")) for i in list(word)]):
                    digits["5"] = word
            ...
            if word_length == 6: # 0, 6, 9
                if "3" in digits and all([i in list(word) for i in list(digits.get("3"))]):
                    digits["9"] = word
                    
                elif "5" in digits and sum([i in list(digits.get("5")) for i in list(word)]) == 5:
                    digits["6"] = word
                    
                elif "5" in digits and sum([i in list(digits.get("5")) for i in list(word)]) == 4:
                    digits["0"] = word
